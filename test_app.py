...
def test_post_item(client):
    ...
    response_get = client.get(REQUEST_ITEM_NAME.format(name=name))
...
def test_put_item(client):
    ...
    response_get2 = client.get(REQUEST_ITEM_NAME.format(name=name))
    ...
    response_get3 = client.get(REQUEST_ITEM_NAME.format(name=name))
